...
export const methodPage = {
  title: "How I write",
  description:
    "How this writing is made: what the AI does, what it does not, and the rule that keeps the sentences mine.",
  ogHeadline: "How I write",
  heading: "How I write",
  ...
  groups: [
    {
      label: "Essays and articles, anything carrying the footer",
      items: [
        { k: "Ideation and prompting", v: "Yes. The AI interrogates my draft; I write the answers." },
        { k: "Structure and gap-finding", v: "Yes. It tells me what is missing; the filling is mine." },
        { k: "Research", v: "Sometimes. Anything it surfaces, I verify before it goes in." },
        { k: "Line editing", v: "Flag-only. It flags; I retype. No AI-authored string enters the file." },
        { k: "Drafting prose", v: "No." },
      ],
    },
    {
      label: "This website, its design, build, and site copy",
      items: [
        { k: "How it was made", v: "Specified, directed, and corrected by me. The prose was AI-crafted at my direction. The claims are mine and verified." },
      ],
    },
    {
      label: "This page",
      items: [
        { k: "How it was made", v: "The tables and definitions here were assembled with AI assistance and approved by me. The story above is written by me, sentence by sentence." },
      ],
    },
  ],
  ruleHeading: "The rule",
  rule:
    "The promise that every unquoted sentence here is mine is enforced by one working rule: no AI-authored string ever enters a draft file. Suggestions get retyped in my own words, or rejected. Quoted material, including the AI's actual questions when I show them, is always marked as quotation.",
  scopeHeading: "Scope and edges",
  scope: [
    { k: "Human editors", v: "If a human editor rewrites lines in a piece, that piece's note says so. The footer's claim is about AI." },
    { k: "Arrangement", v: "If AI ever re-orders or restructures my own sentences, that piece's note says so. Sequencing is authorship too." },
    { k: "No retrofitting", v: "Anything I published before adopting this method, before August 2026, carries no note. Silence there is honesty, not concealment." },
    { k: "Different surfaces, different notes, all true", v: "My essays and this website carry different notes because they were made differently. A note that cannot vary with the truth is not a disclosure; it is a slogan." },
  ],
  whyHeading: "Why this page exists",
  why:
    "This note binds me, not you. A standing public promise makes the smoother machine sentence expensive to accept, so I retype it my way or cut it, and the prose stays mine. If it also helps you decide how to read me, good. If you write and want to state your own method, take any of this; it is a format, not a badge.",
  precision:
    "The text of my essays is authored by me and not generated by AI, except a de minimis amount of text modified by AI-assisted checking that I have retyped or approved. Quoted material is attributed to its source.",
